# dApp area of triangle given all lengths
<a id="readme-top"></a>

<!-- PROJECT LOGO -->
## About
<p>
    This is decentralized application (dapp) for calculating the area of traingle given all lengths. powered by <a href="https://docs.cartesi.io/cartesi-rollups/1.3/">cartesi</a> rollups technology.
</p>
...
1. Clone this repo
   ```sh
   git clone https://github.com/Temidayo2233/Cartesi-Dapps.git
   ```
...
#### Advanced handlers
```
description — calculate the area of a triangle given all lengths.
